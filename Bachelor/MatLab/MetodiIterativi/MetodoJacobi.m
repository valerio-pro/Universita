function [vettoreCalcolato, indiceIterazione, norma2Residuo] = MetodoJacobi(A, b, epsilon, vettoreInnesco, Nmax)
    
    % La seguente funzione implementa il metodo iterativo di Jacobi.
    ...
    % [vettore, indice, normaResiduo] = MetodoJacobi([2,1;1,2], [1;1], 0.00000001, [0;0], 28)

    
    % La matrice precondizionatore del metodo e' ottenuta come la matrice
    % che ha sulla diagonale gli stessi elementi sulla diagonale di "A" e ha
    % 0 in tutte le altre entrate
    D = diag(diag(A));

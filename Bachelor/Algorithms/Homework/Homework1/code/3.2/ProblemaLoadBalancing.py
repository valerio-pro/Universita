...
# - il numero "m" di macchine, e' un'informazione statica, non cambia mai tra i vari sottoproblemi
...
# - un dizionario "taskRimanenti" che associa ad ogni task ancora da schedulare il suo tempo di esecuzione 
class Problema:
